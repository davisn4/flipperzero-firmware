...
// Created with https://techryptic.github.io/
// Kudos to the following contributors who should be highlighted: ChatGPT, MidJourney, Salvador M. (For parallel efforts in the gap.c edits. We independently crafted similar edits to gap.c. Even though I didn't upload mine to GitHub, I wanted to give you a shoutout for your contribution.), shoutout to STMicroelectronics for the GAP commands used in gap.c, willyjlz for the FAP App (They contacted me through Reddit seeking assistance with the conversion.), and several Continuity projects (Openhaystack, AirGuard, Find-You, FakeTag) on GitHubs. 
// This code strictly adheres to ethical standards and does not contain any elements related to the DDoS attacks. If you're seeking such functionalities, please look elsewhere.
// If you want to learn more about the Continuity Protocol: https://cfp.recon.cx/2023/talk/VSYA9H/ and https://cfp.recon.cx/media/2023/submissions/VSYA9H/resources/HandoffReconSlides_Eywqahv.pdf
// Apple consistently introduces new features. If you're looking to capture new BLE notification types, I'd suggest using a Faraday box equipped with a screen. The notifications are standardized, with only a few bytes differentiating them.
...
static void gap_advertise_start(GapState new_state)
{
	...
	const uint8_t choiceSelection[] = {
	  0x07, 0x19, 0x05, 0x00, 0x55, 0x10, 0x00, 0x00, 0x01, 0x06, 0xf6, 0x85, 0xda, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
